...
subtitle: 'Technical details about used stack for my website.'
permalink: 'technical-information'
datePublished: '2025-12-20T17:35:00'
topicId: [1]
tags: ['Programming', 'Web Development', 'Web Design']
options:
  {
    showTitle: true,
    excerpt:
...
I also did the design and prototyping myself. Responsiveness is handled by
[Utopia](https://utopia.fyi/) scripts, which use clamp technology to
...
The website uses EB Garamond and DM Sans fonts which can be downloaded via
[Fontsource](https://fontsource.org/). I prefer clean and uncluttered
interfaces, so I only use the bare minimum of vanilla JavaScript animations.
